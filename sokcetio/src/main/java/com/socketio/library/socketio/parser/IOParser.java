package com.socketio.library.socketio.parser;

import com.socketio.library.hasbinarydata.HasBinaryData;
...
final public class IOParser implements Parser {
    ...
    final public static class Encoder implements Parser.Encoder {
        ...
        public void encode(Packet obj, Callback callback) {
            if ((obj.type == EVENT || obj.type == ACK) && HasBinaryData.hasBinary(obj.data)) {
