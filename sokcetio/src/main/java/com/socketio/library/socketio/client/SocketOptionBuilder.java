...
public class SocketOptionBuilder {
     ...
     * @see SocketOptionBuilder#builder(io.socket.client.IO.Options)
     */
     ...
     * @return new builder object
     */
    public static SocketOptionBuilder builder(io.socket.client.IO.Options options) {
        return new SocketOptionBuilder(options);
    }


    private final io.socket.client.IO.Options options = new io.socket.client.IO.Options();
     ...
     */
    protected SocketOptionBuilder(io.socket.client.IO.Options options) {
        if (options != null) {
